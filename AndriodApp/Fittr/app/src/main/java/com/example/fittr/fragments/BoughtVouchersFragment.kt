...
import com.example.fittr.databinding.FragmentBoughtVouchersBinding
...
class BoughtVouchersFragment : Fragment() {

    private var _binding: FragmentBoughtVouchersBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentBoughtVouchersBinding.inflate(inflater, container, false)
        return binding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        getBoughtVouchers(Variables.userId!!)
    }

    fun getBoughtVouchers(userId : Int)
    {
        val queue = Volley.newRequestQueue(context)
        var url="${Variables.url}/getuservoucherhistory/${userId}"
